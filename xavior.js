...
xavior.sendMessage(m.chat, {audio: goblok, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
 xavior.sendMessage(m.chat, {document: ana, mimetype: 'application/zip', fileName: `XaviorV2.zip`}, {quoted:m})}
            ...
            ana = fs.readFileSync('./Xavior.json')
              m.reply('*Jangan Lupa Follow IG @irfnadi_*')
	...
	break
	    case 'setname': case 'setsubject': {
          ...
          m.reply(`Awokawowk Lu Bukan Owner Asli Gua bre\n\nOwner Asli Gua *Xavior-Ofc* bre...\n\nMastah Kok Sc gratisan 👻\n\nBeli Bre Biar Fiturnya Berjalan`)
            ...
            case 'namafotobot': {
             if (!isCreator) throw mess.owner
             xavior.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/pyXKdjd/lol.png' }, caption: `Foto menu Berhasil Diganti\n\nHei Lord *IrfnCode*..🙏\n\nJangan Sering Sering Ubah Fot Bot Yah🗿` }, { quoted: m })
            } break
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Text mana?\n\nContoh : ${prefix + command} irfan-san`
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'Script',
                                    url: 'https://replit.com/@irfnadi'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 822-8642-5538'
                                }
                            }, {
                                quickReplyButton: {
                                ...
                                urlButton: {
                                    displayText: 'Web Api`s',
                                    url: 'https://irfan-api.herokuapp.com/api'
                                }
                            }]
            ...
            case 'bc': case 'broadcast': case 'bcall': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Text mana?\n\nContoh : ${prefix + command} Follow IG Owner @irfnadi_`
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                ...
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/irfnadi_/'
                                }
                            }]
                      let txt = `「 Broadcast Bot 」\n\n${text}`
...
🔗 *Media Url* : ${images}`,
	    ...
	    case 'play': case 'ytplay': {
                if (!text) throw `Contoh : ${prefix + command} cara menjadi anime`
                let yts = require("yt-search")
                let search = await yts(text)
...
⭔ Url : ${anu.url}`,
           ...
           anu = `Tutorial Memasang Bot Chat Owner Bot!
           WA : 082286425538
           IG : @irfnadi_`
                            let btn = [{
                                           urlButton: {
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            case 'okay': { m.reply('Follow Lah IG @irfnadi_')} break
            
             case 'menu': {
            anu = `Hallo Bre... 🤗\nSalken Bre, Gua *Irfan*🤝\nGua Bot WhatsApp MD Tod..\nBot WA MD V3 Dari *@irfnadi_* Tod`
            let btn = [{
